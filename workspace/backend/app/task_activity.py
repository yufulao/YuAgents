    ...
    *,
    ...
    if camel_case:
        return {
            ...
            "laneType": task.lane_type or "unspecified",
            "writeScope": task.write_scope or [],
            "resourceLocks": task.resource_locks or [],
            "conflictsWith": task.conflicts_with or [],
            "commitPolicy": task.commit_policy or {},
            "dependencies": dependencies,
            "result": task.result,
            "updatedAt": task.updated_at.isoformat() if task.updated_at else None,
